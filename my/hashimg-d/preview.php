...
<body class='bg-gray-900'>
    ...
    <p class='text-xs text-red-500'><?php
        if ($_SESSION['HashStatus'] == 'false') {
            echo "This message has been modified by a third party or this message is corrupted.";
        }
    ?></p>
    <a href="../../" class="inline-flex items-center text-red-600 hover:underline mt-3">
       Exit
